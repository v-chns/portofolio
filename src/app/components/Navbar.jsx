...
const Navbar = () => {
    ...
    return (
        <nav className="fixed mx-auto border border-[#33353F] border-l-transparent border-r-transparent top-0 left-0 right-0 z-10 bg-[#1a1a1a] bg-opacity-80 backdrop-blur-sm">
